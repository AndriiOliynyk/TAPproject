...
app = FastAPI()
router=APIRouter()
@router.get("/camera2", response_class=HTMLResponse)
def camera_details():
    camera_name = "Fujifilm INSTAX Mini 12 Lilac Purple"
    image_url = "https://i.moyo.ua/img/products/5382/82_600.jpg"
    description = """Type: Instant Film Camera
                    Color: Lilac Purple
                    Film Format: Fujifilm INSTAX Mini Film
                        Image Size: 62mm × 46mm
                        Lens: Retractable lens design
                        Focal length: 60mm
                        Shutter Speed: 1/2 to 1/250 seconds (automatic adjustment)
                        Exposure Control: Automatic
                        Power: Two AA batteries
                        Dimensions: 104mm × 66.6mm × 122mm (W × H × D)
                        Weight: Approximately 306g (without batteries and film pack)"""
