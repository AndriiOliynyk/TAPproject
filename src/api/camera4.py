...
app = FastAPI()
router=APIRouter()
@router.get("/camera4", response_class=HTMLResponse)
def camera_details():
    camera_name = "Sony Cyber-shot DSC-RX10 IV Digital Camera"
    image_url = "https://fotosale.ua/images/products/40/products.40144.1.b.jpg"
    description = """Camera Body (Nikon D850):
Imaging and Performance:
Sensor: 20.1 MP 1.0-inch stacked Exmor RS CMOS sensor for exceptional detail and clarity.
Processor: BIONZ X image processor with front-end LSI for fast processing and improved image quality.
ISO Range: 100-12,800 (expandable to 64-25,600) for excellent low-light performance.
Autofocus: 315-point phase-detection AF system for fast and precise focusing, with Real-Time Eye AF and subject tracking.
Lens:
Model: ZEISS Vario-Sonnar T* 24-600mm equivalent f/2.4-4 lens.
Zoom: 25x optical zoom for capturing a wide range of subjects, from landscapes to distant wildlife.
Aperture: Bright f/2.4-4 maximum aperture for better low-light shots and depth-of-field control.
"""
